# Generated by Powerlevel10k configuration wizard on 2025-04-20 at 09:01 EDT.
...
# 24h time, slanted separators, round heads, flat tails, 2 lines, disconnected,
...
() {
  ...
  function prompt_valet_php() {
    _p9k_upglob composer.json -.
    local -i idx=$?
    (( idx )) || return
    version="$(valet php -r 'echo phpversion();')"
    p10k segment -f 'fuchsia' -i $'\uE608' -t $version
  }

  function instant_prompt_valet_pop() {
    prompt_valet_php
  }
